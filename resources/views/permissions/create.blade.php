...
<div class="custom-container">
  ...
  <div class="d-flex align-items-center gap-3 mb-6">
    ...
    <div>
      ...
      <p class="text-secondary mb-0">Create a new permission and assign it to roles.</p>
    </div>
  </div>
      ...
      <form action="{{ route('permissions.store') }}" method="POST">
        ...
        <div class="row g-4 mb-4">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" placeholder="e.g. CREATE_USER" value="{{ old('code') }}" required style="text-transform: uppercase;">
