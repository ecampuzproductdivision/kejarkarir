...
<div class="custom-container">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-6">
    <div>
      ...
      <p class="text-secondary mb-0">Organize application navigation menus and their hierarchy.</p>
    </div>
    <div class="d-flex gap-2">
      @can('MENU_CREATE')
      <a href="{{ route('menus.create') }}" class="btn btn-dark d-flex align-items-center gap-2">
  ...
  <div class="card mb-6 shadow-sm border-0">
    <div class="card-body p-4">
      <form action="{{ route('menus.index') }}" method="GET" class="row g-3 align-items-center">
        <div class="col-md-5">
        ...
        <div class="col-md-auto">
          <a href="{{ route('menus.index') }}" class="btn btn-light border btn-icon rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 38px; height: 38px;">
  ...
  <div class="d-flex align-items-center gap-2 mb-4 text-secondary">
    ...
    <span class="fw-semibold">Showing {{ $menus->count() }} from {{ App\Models\Menu::count() }} data</span>
  </div>
    ...
    <div class="table-responsive">
      <table class="table table-hover table-centered text-nowrap mb-0">
        <thead class="table-light">
          <tr>
            <th class="py-4 ps-4">NAME</th>
            <th class="py-4">URL</th>
            <th class="py-4">PARENT</th>
            <th class="py-4 text-center">ORDER</th>
            <th class="py-4">STATUS</th>
            <th class="py-4 text-center">CHILDREN</th>
